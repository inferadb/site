---
layout: docs
title: Documentation — InferaDB
doc_title: What is InferaDB?
doc_subtitle: A distributed authorization database for fine-grained access control at scale.
---

InferaDB is an inference-driven authorization database that answers the question every application must ask — _"can this user do this?"_ — in microseconds.
...
The fastest way to start is the [Quick Start guide](/docs/quickstart), which walks you through running InferaDB locally and making your first authorization check in under 5 minutes.
